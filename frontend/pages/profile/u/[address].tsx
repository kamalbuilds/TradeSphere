            ...
            <>
              ...
              <div className={styles.cardcontent}>
                ...
                {profileData.find(profile => profile.address.startsWith('0x')) && (
                  <div className="cardaddress" style={{color: 'lightgray'}}>
          ...
          <div className={styles.cardcontent}>
            <div className={styles.cardbadges}>
              {profileData.flatMap(profile => profile.links ? Object.keys(profile.links).map((linkKey, linkIndex) => {
                ...
                return (
                  <a key={profile.links[linkKey].handle} className={`platformbadge ${badgeColor}`} title={`${profile.identity} ${profile.platform}`} href={profile.links[linkKey].link} target="_blank" rel="noopener noreferrer">
                    <div className="platformbadgeicon">
                      <BadgeIcon />
                    </div>
                    <span className="platformbadgename">{profile.links[linkKey].handle}</span>
                  </a>
                );
