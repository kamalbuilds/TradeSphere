...
import safeLogoDark from '../../public/safe-info-logo-dark.svg'
import { utils } from 'ethers';
import { AiOutlineWarning } from "react-icons/ai";
import AddressLabel from '../../helpers/AddressLabel';
import AmountLabel from '../../helpers/AmountLabel';
        ...
        <div>
            ...
            <div>
                <div className='flex flex-row gap-2 items-center ' >
                    ...
                    <p className='text-[16px] text-gray-400'>Safe Details</p>
                </div>
                <div className='mt-4'>
                    <p className='text-[34px]'>Safe Details</p>
                    <p className='text-[14px] text-gray-400'>Safes associated with your account</p>
                </div>
            </div>
            ...
            <div className='flex flex-col gap-4 my-8'>
                <p className='text-[24px]'>Safe Address</p>
            ...
            <div className='flex flex-col gap-4 my-8'>
                <p className='text-[24px]'>Deployment Status</p>
                <div className='flex flex-row gap-2 items-center'>
            ...
            <div className='flex flex-col gap-4 my-8'>
                <p className='text-[24pxpx]'>Recent Transactions</p>
                <p>No Transactions</p>
            </div>
